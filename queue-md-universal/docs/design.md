...
> **Last Updated:** May 2026 | **Version:** 3.5
...
7. **Facility Visual Identity:** Each facility type (Clinic, Pathlab, Dental, Physio) uses a unique emoji (e.g., 🧘 for Physio) and a simplified human-readable label for a cleaner, more intuitive dashboard experience.
